...
namespace WindowsFormsApp1
{
    ...
    {
        int ColIndex = -1;
        FileInfo txtFile = new FileInfo("log.txt");
        ...
        public Form1()
        {
            ...
            StreamWriter sw = txtFile.AppendText();
            sw.WriteLine("Начало логирования в " + DateTime.Now);
            sw.Flush();
        ...
        private void dgv_CellValidating(object sender, DataGridViewCellValidatingEventArgs e)
        {
            ...
            {
                StreamWriter sw = txtFile.AppendText();
                sw.WriteLine("dgv_CellValidating " + DateTime.Now);
                sw.Flush();
                e.Cancel = true;
            }
        }
        ...
        private void tbC_Validating(object sender, CancelEventArgs e)
        {
            ...
            {
                StreamWriter sw = txtFile.AppendText();
                sw.WriteLine("tbC_Validating " + DateTime.Now);
                sw.Flush();
                e.Cancel = true;
            }
        }
        ...
        private void tbT_Validating(object sender, CancelEventArgs e)
        {
            ...
            {
                StreamWriter sw = txtFile.AppendText();
                sw.WriteLine("tbT_Validating " + DateTime.Now);
                sw.Flush();
                e.Cancel = true;
            }
        }
